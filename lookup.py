...
dexno = dict((v,k) for k, v in species.iteritems())

formes = {#forme-name: [species,fakenum,forme num]
	'Rotom-Heat': ['Rotom',1001,1],
	'Rotom-Wash': ['Rotom',1001,2],
	'Rotom-Frost': ['Rotom',1001,3],
	'Rotom-Fan': ['Rotom',1001,4],
	'Rotom-Mow': ['Rotom',1001,5],
	'Giratina-Origin': ['Giratina',1002,1],
	'Shaymin-Sky': ['Shaymin',1003,1],
	'Deoxys-Attack': ['Deoxys',1004,1],
	'Deoxys-Defense': ['Deoxys',1005,2],
	'Deoxys-Speed': ['Deoxys',1006,3],
	'Wormadam-Sandy': ['Wormadam',1007,1],
...
inv_nature = dict((v,k) for k, v in nature.iteritems())
...
inv_abilities = dict((v,k) for k, v in abilityLU.iteritems())
...
inv_items = dict((v,k) for k, v in items.iteritems())
...
pokestats = {
    ...
    1001: (2, 50, 65,107,105,107, 86), #rotom forme
    1002: (4,150,120,100,120,100, 90), #giratina-o
    1003: (3,100,103, 75,120, 75,127), #shaymin-s
    1004: (4, 50,180, 20,180, 20,150), #deoxys-a
    1005: (4, 50, 70,160, 70,160, 90), #deoxys-d
    1006: (4, 50, 95, 90, 95, 90,180), #deoxys-s
    1007: (2, 60, 79,105, 59, 85, 36), #wormadam-g
    1008: (2, 60, 69, 95, 69, 95, 36), #wormadam-s
    1009: (4, 79,100, 80,110, 90,121), #tornadus-t
    1010: (4, 79,105, 70,145, 80,101), #thundurus-t
    1011: (4,125,170, 90,120,100, 95), #kyurem-b
    1012: (4,125,120, 90,170,100, 95), #kyurem-w
    1013: (4, 89,145, 90,105, 80, 91)  #landorus-t
}
